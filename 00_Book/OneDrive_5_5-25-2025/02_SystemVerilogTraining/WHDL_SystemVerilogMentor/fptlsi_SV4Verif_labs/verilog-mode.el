...
;;
;; $Id: verilog-mode.el 266 2006-09-19 16:09:50Z mac $
...
(defconst verilog-mode-version (substring "$$Revision: 266 $$" 12 -3)
...
(defun verilog-delete-auto-star-implicit ()
  "Delete all non-templated .* implicit connections that were created
by .*, `verilog-auto-star'.
...
and/or see http://www.veripool.com"
  (interactive)
...
(defun verilog-load-file-at-mouse (event)
  "Load file under button 2 click.
...
Snyder (wsnyder@wsnyder.org or wsnyder@world.std.com) and/or see
http://www.veripool.com.  You may also want to look at the Verilog-Mode
FAQ, see http://www.veripool.com/verilog-mode-faq.html.
